...
internals.getArticle = function(request, reply) {
    ...
    if (context == {}) {
        ...
        context.inlineStyle = fs.readFileSync(Path.join(__dirname, '../bower_components/bootswatch-dist/css/bootstrap.min.css'), 'utf8')
            + fs.readFileSync(Path.join(__dirname, '../bower_components/ionicons/css/ionicons.min.css'), 'utf8')
            + fs.readFileSync(Path.join(__dirname, '../static/main.css'), 'utf8')
            + fs.readFileSync(Path.join(__dirname, '../static/mermaid.css'), 'utf8') ;

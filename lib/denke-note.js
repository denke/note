...
exports.processContent = function(_config,callback) {
    config = _.defaults(_config, config);
    internals.processContent(callback);
}
/* 
...
/* 
 * Process files and save the website
 */
exports.save = function(_config) {
    ...
    config.baseUrl = './';
    config.pdf = false;
    internals.processContent(config, internals.save);
};
